...
export default function Home() {
  ...
  React.useEffect(() => {
    ...
    if (filters.quiz !== 'all') {
      ...
      const startIndex = (quizNumber - 1) * QUIZ_QUESTION_COUNT;
      
      if (quizNumber === 6) {
        tempQuestions = chapterSortedQuestions.slice(startIndex); // From 125 to end
      } else {
        const endIndex = startIndex + QUIZ_QUESTION_COUNT;
